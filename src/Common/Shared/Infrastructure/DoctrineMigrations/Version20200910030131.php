 ...
 */
final class Version20200910030131 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE `user` (id BINARY(16) NOT NULL COMMENT \'(DC2Type:uuid_binary)\', enabled TINYINT(1) NOT NULL, roles JSON NOT NULL, registered_by_id BINARY(16) DEFAULT NULL COMMENT \'(DC2Type:uuid_binary)\', date_registered DATETIME NOT NULL COMMENT \'(DC2Type:datetime_immutable)\', email VARCHAR(255) NOT NULL, password VARCHAR(128) NOT NULL, UNIQUE INDEX UNIQ_8D93D649E7927C74 (email), INDEX IDX_8D93D64950F9BB84 (enabled), INDEX IDX_8D93D64927E92E18 (registered_by_id), INDEX IDX_8D93D64987CDE0C6 (date_registered), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
