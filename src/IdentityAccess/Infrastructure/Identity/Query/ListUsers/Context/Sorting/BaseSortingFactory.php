...
use Common\Shared\Infrastructure\Query\Context\AbstractSortingFactory;
use IdentityAccess\Infrastructure\Identity\Query\UserModelClassSupportedTrait;

/**
 * Class BaseSortingFactory.
 */
abstract class BaseSortingFactory extends AbstractSortingFactory
{
