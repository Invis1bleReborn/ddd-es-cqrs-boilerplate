 ...
 */
class ChangeRolesRequestTransformer extends ValidatorAwareRequestTransformer implements
    ChangeRolesRequestTransformerInterface
{
    /**
     * {@inheritdoc}
     */
